# INTERMEDIO 12 - subrecursos REST
...
Estas construyendo una solucion backend con Node.js y Express para un escenario relacionado con peliculas de miedo. El objetivo es aprender paso a paso como se piensa, organiza y prueba una API real sin saltar conceptos importantes.

Este ejercicio se enfoca en subrecursos REST. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```text
intermedio/ejercicio-12/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
