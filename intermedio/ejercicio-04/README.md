# INTERMEDIO 04 - servicios reutilizables
...
Este ejercicio se enfoca en servicios reutilizables. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```text
intermedio/ejercicio-04/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
