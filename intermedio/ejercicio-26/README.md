# INTERMEDIO 26 - mock de dependencias
...
Este ejercicio se enfoca en mock de dependencias. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```text
intermedio/ejercicio-26/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
