# INTERMEDIO 17 - roles y permisos
...
Este ejercicio se enfoca en roles y permisos. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```text
intermedio/ejercicio-17/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
