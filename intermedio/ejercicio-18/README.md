# INTERMEDIO 18 - hash de passwords conceptual
...
Estas construyendo una solucion backend con Node.js y Express para un escenario relacionado con paracaidismo. El objetivo es aprender paso a paso como se piensa, organiza y prueba una API real sin saltar conceptos importantes.

Este ejercicio se enfoca en hash de passwords conceptual. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```json
{
  ...
  "topic": "hash de passwords conceptual"
}
```
...
```text
intermedio/ejercicio-18/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
