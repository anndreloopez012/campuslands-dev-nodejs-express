# INTERMEDIO 16 - rutas protegidas
...
Este ejercicio se enfoca en rutas protegidas. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```text
intermedio/ejercicio-16/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
