# INTERMEDIO 08 - middleware de request id
...
Estas construyendo una solucion backend con Node.js y Express para un escenario relacionado con hiperdeportivos. El objetivo es aprender paso a paso como se piensa, organiza y prueba una API real sin saltar conceptos importantes.

Este ejercicio se enfoca en middleware de request id. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```json
{
  ...
  "topic": "middleware de request id"
}
```
...
```text
intermedio/ejercicio-08/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
