# INTERMEDIO 03 - controladores limpios
...
Este ejercicio se enfoca en controladores limpios. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```text
intermedio/ejercicio-03/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
