...
Este ejercicio se enfoca en refactor de API. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```text
intermedio/ejercicio-29/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
