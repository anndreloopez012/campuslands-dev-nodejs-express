# INTERMEDIO 27 - documentacion de endpoints
...
Este ejercicio se enfoca en documentacion de endpoints. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```json
{
  ...
  "topic": "documentacion de endpoints"
}
```
...
```text
intermedio/ejercicio-27/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
