# INTERMEDIO 22 - subida simulada de archivos
...
Estas construyendo una solucion backend con Node.js y Express para un escenario relacionado con arquitectura 3D. El objetivo es aprender paso a paso como se piensa, organiza y prueba una API real sin saltar conceptos importantes.

Este ejercicio se enfoca en subida simulada de archivos. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```json
{
  ...
  "topic": "subida simulada de archivos"
}
```
...
```text
intermedio/ejercicio-22/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
