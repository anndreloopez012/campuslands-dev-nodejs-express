# INTERMEDIO 06 - validacion centralizada
...
Este ejercicio se enfoca en validacion centralizada. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```text
intermedio/ejercicio-06/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
