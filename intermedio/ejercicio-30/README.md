# INTERMEDIO 30 - proyecto integrador intermedio

## Dificultad

Intermedio integrador
...
Estas construyendo una solucion backend con Node.js y Express para un escenario relacionado con motos y mecanica. El objetivo es aprender paso a paso como se piensa, organiza y prueba una API real sin saltar conceptos importantes.

Este ejercicio se enfoca en proyecto integrador intermedio. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```json
{
  ...
  "topic": "proyecto integrador intermedio"
}
```
...
```text
intermedio/ejercicio-30/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
