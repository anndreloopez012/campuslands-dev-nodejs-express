# INTERMEDIO 01 - arquitectura por capas
...
Este ejercicio se enfoca en arquitectura por capas. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```text
intermedio/ejercicio-01/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
