# INTERMEDIO 24 - testing de servicios
...
Estas construyendo una solucion backend con Node.js y Express para un escenario relacionado con formulas quimicas. El objetivo es aprender paso a paso como se piensa, organiza y prueba una API real sin saltar conceptos importantes.

Este ejercicio se enfoca en testing de servicios. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```text
intermedio/ejercicio-24/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
