# INTERMEDIO 23 - testing con node test
...
Estas construyendo una solucion backend con Node.js y Express para un escenario relacionado con soldadura. El objetivo es aprender paso a paso como se piensa, organiza y prueba una API real sin saltar conceptos importantes.

Este ejercicio se enfoca en testing con node test. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```text
intermedio/ejercicio-23/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
