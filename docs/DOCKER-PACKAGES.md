...
```bash
docker pull ghcr.io/anndreloopez012/campuslands-dev-nodejs-express:dev
docker run --rm -p 8080:80 ghcr.io/anndreloopez012/campuslands-dev-nodejs-express:dev
```
...
- `dev` publica la etiqueta `ghcr.io/anndreloopez012/campuslands-dev-nodejs-express:dev`.
- `main` publica la etiqueta `ghcr.io/anndreloopez012/campuslands-dev-nodejs-express:latest`.
