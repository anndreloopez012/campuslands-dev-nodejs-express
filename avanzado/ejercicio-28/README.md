# AVANZADO 28 - separacion app server
...
Este ejercicio se enfoca en separacion app server. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```text
avanzado/ejercicio-28/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
