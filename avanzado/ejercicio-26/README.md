# AVANZADO 26 - fixtures y factories
...
Este ejercicio se enfoca en fixtures y factories. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```text
avanzado/ejercicio-26/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
