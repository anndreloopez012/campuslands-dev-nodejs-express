# AVANZADO 22 - webhooks simulados
...
Este ejercicio se enfoca en webhooks simulados. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```text
avanzado/ejercicio-22/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
