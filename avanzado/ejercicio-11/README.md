# AVANZADO 11 - importacion masiva
...
Estas construyendo una solucion backend con Node.js y Express para un escenario relacionado con musica. El objetivo es aprender paso a paso como se piensa, organiza y prueba una API real sin saltar conceptos importantes.

Este ejercicio se enfoca en importacion masiva. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```text
avanzado/ejercicio-11/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
