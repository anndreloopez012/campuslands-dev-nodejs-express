# AVANZADO 03 - validacion con schemas
...
Este ejercicio se enfoca en validacion con schemas. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```text
avanzado/ejercicio-03/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
