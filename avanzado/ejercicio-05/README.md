# AVANZADO 05 - transacciones simuladas
...
Este ejercicio se enfoca en transacciones simuladas. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```text
avanzado/ejercicio-05/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
