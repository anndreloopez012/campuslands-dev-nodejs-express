...
Este ejercicio se enfoca en jobs programados. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```text
avanzado/ejercicio-23/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
