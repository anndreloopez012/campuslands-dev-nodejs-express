# AVANZADO 02 - arquitectura escalable
...
Este ejercicio se enfoca en arquitectura escalable. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```text
avanzado/ejercicio-02/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
