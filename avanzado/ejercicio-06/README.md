# AVANZADO 06 - colas de tareas conceptuales
...
Este ejercicio se enfoca en colas de tareas conceptuales. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```json
{
  ...
  "topic": "colas de tareas conceptuales"
}
```
...
```text
avanzado/ejercicio-06/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
