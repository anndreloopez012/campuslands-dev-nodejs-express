# AVANZADO 24 - documentacion OpenAPI manual
...
Este ejercicio se enfoca en documentacion OpenAPI manual. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```json
{
  ...
  "topic": "documentacion OpenAPI manual"
}
```
...
```text
avanzado/ejercicio-24/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
