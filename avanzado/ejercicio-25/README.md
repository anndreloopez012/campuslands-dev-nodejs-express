# AVANZADO 25 - testing de integracion
...
Este ejercicio se enfoca en testing de integracion. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```text
avanzado/ejercicio-25/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
