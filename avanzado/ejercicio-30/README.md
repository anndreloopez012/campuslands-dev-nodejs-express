# AVANZADO 30 - proyecto final avanzado
...
Este ejercicio se enfoca en proyecto final avanzado. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```text
avanzado/ejercicio-30/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
