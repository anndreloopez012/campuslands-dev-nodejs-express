# AVANZADO 21 - concurrencia controlada
...
Este ejercicio se enfoca en concurrencia controlada. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```text
avanzado/ejercicio-21/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
