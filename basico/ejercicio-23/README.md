...
Este ejercicio se enfoca en datos en memoria. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```text
basico/ejercicio-23/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
