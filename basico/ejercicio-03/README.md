...
Este ejercicio se enfoca en modulos CommonJS. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```text
basico/ejercicio-03/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
