...
Este ejercicio se enfoca en funciones asincronas. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```text
basico/ejercicio-10/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
