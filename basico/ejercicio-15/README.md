...
Este ejercicio se enfoca en mini API HTTP nativa. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```text
basico/ejercicio-15/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
