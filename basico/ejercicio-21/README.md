...
Este ejercicio se enfoca en estructura src routes controllers. No se busca hacer una aplicacion gigante, sino dominar una pieza concreta del backend profesional.
...
```text
basico/ejercicio-21/resoluciones/nombre-apellido/
├── package.json
├── README.md
└── src/
    ├── app.js
